...
class SystemUIHyperFocusHook : BaseHook() {
    ...
    companion object {
        private const val ACTION_LYRIC_DATA = "com.lyricnotify.focus.action.LYRIC_DATA"
        private const val ACTION_UPDATE_LYRIC = "com.lyricnotify.focus.action.UPDATE_LYRIC"
        private const val ACTION_ALARM_TICK = "com.lyricnotify.focus.systemui.action.ALARM_TICK"
        private const val ACTION_PLAYBACK_STATE = "com.lyricnotify.focus.action.PLAYBACK_STATE"
