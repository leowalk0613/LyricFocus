...
import com.lyricnotify.focus.MainActivity
import com.lyricnotify.focus.R
import com.lyricnotify.focus.FocusPreferences
import com.lyricnotify.focus.lyric.LyricInfo
import com.lyricnotify.focus.lyric.LyricManager
...
class LyricService : Service(), MusicMonitorService.MusicStateListener {
    ...
    companion object {
        ...
        const val ACTION_START = "com.lyricnotify.focus.action.START"
        const val ACTION_STOP = "com.lyricnotify.focus.action.STOP"
        const val ACTION_UPDATE_LYRIC = "com.lyricnotify.focus.action.UPDATE_LYRIC"
        const val ACTION_ALARM_TICK = "com.lyricnotify.focus.action.ALARM_TICK"
