...
object FocusPreferences {
    ...
    const val ACTION_SETTINGS_CHANGED = "com.lyricnotify.focus.action.SETTINGS_CHANGED"
    /** SystemUI 重启后请求 App 重推当前歌词/焦点状态 */
    const val ACTION_REQUEST_RESYNC = "com.lyricnotify.focus.action.REQUEST_RESYNC"
